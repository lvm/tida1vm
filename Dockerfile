...
RUN apt-get update \
    ...
    && wget https://github.com/lvm/Tidal/archive/0.9-dev.zip -O $HOME/tidal-0.9.zip \
    && wget https://github.com/lvm/tidal-midi/archive/0.9-dev.zip -O $HOME/tidal-midi-0.9.zip \
