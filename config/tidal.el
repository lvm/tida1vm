...
(defun tidal-start-haskell ()
  ...
  (tidal-send-string "midi4 <- midiStream devices \"Midi Through Port-0\" 4 synthController")
  (tidal-send-string "midi5 <- midiStream devices \"Midi Through Port-0\" 5 synthController")
  (tidal-send-string "midi6 <- midiStream devices \"Midi Through Port-0\" 6 synthController")
  (tidal-send-string "midi7 <- midiStream devices \"Midi Through Port-0\" 7 synthController")
  (tidal-send-string "midi8 <- midiStream devices \"Midi Through Port-0\" 8 synthController")
  (tidal-send-string "midi9 <- midiStream devices \"Midi Through Port-0\" 9 synthController")
  (tidal-send-string "midi10 <- midiStream devices \"Midi Through Port-0\" 10 synthController")
  (tidal-send-string "midi11 <- midiStream devices \"Midi Through Port-0\" 11 synthController")
  (tidal-send-string "midi12 <- midiStream devices \"Midi Through Port-0\" 12 synthController")
  (tidal-send-string "midi13 <- midiStream devices \"Midi Through Port-0\" 13 synthController")
  (tidal-send-string "midi14 <- midiStream devices \"Midi Through Port-0\" 14 synthController")
  (tidal-send-string "midi15 <- midiStream devices \"Midi Through Port-0\" 15 synthController")
  (tidal-send-string "midi16 <- midiStream devices \"Midi Through Port-0\" 16 synthController")
  ;; end of midi
