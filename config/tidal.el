...
(defun tidal-start-haskell ()
  ...
  ;;(tidal-send-string "(beats, btt) <- midiSetters devices \"Midi Through Port-0\" 1 beats getNow")
  ;;(tidal-send-string "(bass, bst) <- midiSetters devices \"Midi Through Port-0\" 2 bass getNow")
  (tidal-send-string "(drums, gmt) <- midiSetters devices \"Midi Through Port-0\" 3 gmdrums getNow")
  ...
  (tidal-send-string "let hush = mapM_ ($ silence) [drums,midi4,midi5,midi6,midi7,midi8,midi9,midi10,midi11,midi12,midi13,midi14,midi15,midi16]")
