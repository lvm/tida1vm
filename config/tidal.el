...
(defun tidal-start-haskell ()
  ...
  (tidal-send-string "(beat, t1) <- midiStream devices \"Midi Through Port-0\" 1 beatsController getNow")
  (tidal-send-string "(bass, t2) <- midiStream devices \"Midi Through Port-0\" 2 bassController getNow")
  (tidal-send-string "(drums, t3) <- midiStream devices \"Midi Through Port-0\" 3 percController getNow")
  (tidal-send-string "(midi4, t4) <- midiStream devices \"Midi Through Port-0\" 4 synthController getNow")
  (tidal-send-string "(midi5, t5) <- midiStream devices \"Midi Through Port-0\" 5 synthController getNow")
  (tidal-send-string "(midi6, t6) <- midiStream devices \"Midi Through Port-0\" 6 synthController getNow")
  (tidal-send-string "(midi7, t7) <- midiStream devices \"Midi Through Port-0\" 7 synthController getNow")
  (tidal-send-string "(midi8, t8) <- midiStream devices \"Midi Through Port-0\" 8 synthController getNow")
  (tidal-send-string "(midi9, t9) <- midiStream devices \"Midi Through Port-0\" 9 synthController getNow")
  (tidal-send-string "(midi10, t10) <- midiStream devices \"Midi Through Port-0\" 10 synthController getNow")
  (tidal-send-string "(midi11, t11) <- midiStream devices \"Midi Through Port-0\" 11 synthController getNow")
  (tidal-send-string "(midi12, t12) <- midiStream devices \"Midi Through Port-0\" 12 synthController getNow")
  (tidal-send-string "(midi13, t13) <- midiStream devices \"Midi Through Port-0\" 13 synthController getNow")
  (tidal-send-string "(midi14, t14) <- midiStream devices \"Midi Through Port-0\" 14 synthController getNow")
  (tidal-send-string "(midi15, t15) <- midiStream devices \"Midi Through Port-0\" 15 synthController getNow")
  (tidal-send-string "(midi16, t16) <- midiStream devices \"Midi Through Port-0\" 16 synthController getNow")
  ;; end of midi
