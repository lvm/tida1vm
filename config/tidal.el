...
(defun tidal-start-haskell ()
  ...
  (tidal-send-string "beat <- midiStream devices \"Midi Through Port-0\" 10 beatsController")
  (tidal-send-string "bass <- midiStream devices \"Midi Through Port-0\" 2 bassController")
  (tidal-send-string "fm <- midiStream devices \"Midi Through Port-0\" 1 bassController")
  (tidal-send-string "beat' <- midiStream devices \"Midi Through Port-0\" 10 beatsController")
  (tidal-send-string "bass' <- midiStream devices \"Midi Through Port-0\" 2 bassController")
  (tidal-send-string "fm' <- midiStream devices \"Midi Through Port-0\" 1 bassController")
  ...
  (tidal-send-string "let hush = mapM_ ($ silence) [beat,bass,fm, beat',bass',fm']")
