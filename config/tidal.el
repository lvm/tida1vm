...
(defun tidal-start-haskell ()
  ...
  (tidal-send-string "import Data.Maybe")
  ...
  (tidal-send-string "import Sound.Tidal.Utils")
  ...
  (tidal-send-string "import Sound.Tidal.MIDI.VolcaFM")
  (tidal-send-string "devices <- midiDevices")
  (tidal-send-string "beats <- midiStream devices \"Midi Through Port-0\" 10 beatsController")
  (tidal-send-string "bass <- midiStream devices \"Midi Through Port-0\" 2 bassController")
  (tidal-send-string "fm <- midiStream devices \"Midi Through Port-0\" 1 fmController")
  ...
  (tidal-send-string "let hush = mapM_ ($ silence) [beats,bass,fm, d1,d2,d3,4]")
